...
## 7. Раздел "Источники" (Iteration 9)
...
- Создание/удаление источников и редактирование cron/правил extraction пока выполняются через API (бот покрывает просмотр, toggle и parse-now).
